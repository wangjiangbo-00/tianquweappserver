...
public class ClientCustomSSL{
    ...
    public static String doRefund(String url, String data) throws Exception {
        ...
        {
             is = new FileInputStream(new File("D:\\proj\\tcwxappserver\\webserver\\src\\main\\resources\\cert\\apiclient_cert.p12" ));
        }
        else
        {
            is = new FileInputStream(new File("/home/zhenxintc/wxappserver/1_tomcat/conf/cert_wx/apiclient_cert.p12" ));
        }
        ...
        try {
            keyStore.load(is, "1514558261".toCharArray());// 这里写密码..默认是你的MCHID
            SSLContext sslcontext = SSLContexts.custom()
                    .loadKeyMaterial(keyStore, "1514558261".toCharArray())// 这里也是写密码的
                    .build();
...
// Trust own CA and all self-signed certs
    ...
    public static String dowithdrew(String url, String data) throws Exception {
